...
info->mu /= 391;
PRINTTEXT("This is double_integrator_QP_solver_noCD, a solver generated by FORCES (forces.ethz.ch).\n");
...
PRINTTEXT("OPTIMAL (within RESEQ=%2.1e, RESINEQ=%2.1e, (R)DGAP=(%2.1e)%2.1e, MU=%2.1e).\n",double_integrator_QP_solver_noCD_SET_ACC_RESEQ, double_integrator_QP_solver_noCD_SET_ACC_RESINEQ,double_integrator_QP_solver_noCD_SET_ACC_KKTCOMPL,double_integrator_QP_solver_noCD_SET_ACC_RDGAP,double_integrator_QP_solver_noCD_SET_ACC_KKTCOMPL);
