function [output, exitflag, info] = run_QP_solver_noCD_exp(args)
    ...
    f1_string = strcat(f1_string, ' N-1;');
    for j=1:nX
...
%     end
    ...
    % Solve
    [output exitflag info] = double_integrator_QP_solver_noCD_exp(params);
