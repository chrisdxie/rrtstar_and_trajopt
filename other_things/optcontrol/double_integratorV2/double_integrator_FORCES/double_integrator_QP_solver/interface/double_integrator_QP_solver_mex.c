...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )  
{
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C1 must be of size [9 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C1, 135);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C2 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C2, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C3 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C3, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C4 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C4, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C5 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C5, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C6 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C6, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C7 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C7, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C8 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C8, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C9 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C9, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C10 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C10, 75);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 15 ) {
    mexErrMsgTxt("PARAMS.C11 must be of size [5 x 15]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C11, 75);
