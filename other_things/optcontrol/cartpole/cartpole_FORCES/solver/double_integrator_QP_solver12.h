...
typedef struct double_integrator_QP_solver_params
{
    ...
    double_integrator_QP_solver_FLOAT A11[330];

    /* vector of size 22 */
    double_integrator_QP_solver_FLOAT b11[22];

    /* vector of size 4 */
    double_integrator_QP_solver_FLOAT f12[4];
    ...
    double_integrator_QP_solver_FLOAT A12[32];

    /* vector of size 8 */
    double_integrator_QP_solver_FLOAT b12[8];
