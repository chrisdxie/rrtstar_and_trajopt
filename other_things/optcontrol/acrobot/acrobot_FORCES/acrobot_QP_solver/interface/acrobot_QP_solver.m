% acrobot_QP_solver - a fast interior point code generated by FORCES
%
%   OUTPUT = acrobot_QP_solver(PARAMS) solves a multistage problem
...
%       PARAMS.lb10 - column vector of length 5
%       PARAMS.ub10 - column vector of length 5
%
...
%       OUTPUT.z10 - column vector of size 5
%
%   [OUTPUT, EXITFLAG] = acrobot_QP_solver(PARAMS) returns additionally
%   the integer EXITFLAG indicating the state of the solution with 
%       1 - Optimal solution has been found (subject to desired accuracy)
%       0 - Maximum number of interior point iterations reached
%      -7 - Line search could not progress
%
%   [OUTPUT, EXITFLAG, INFO] = acrobot_QP_solver(PARAMS) returns 
