...
/* copy functions */
void copyCArrayToM(acrobot_QP_solver_FLOAT *src, double *dest, int dim) {
    while (dim--) {
        *dest++ = (double)*src++;
    }
}
void copyMArrayToC(double *src, acrobot_QP_solver_FLOAT *dest, int dim) {
    while (dim--) {
        *dest++ = (acrobot_QP_solver_FLOAT)*src++;
    }
}
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )  
{
	...
	int exitflag;
	const char *fname;
	const char *outputnames[10] = {"z1","z2","z3","z4","z5","z6","z7","z8","z9","z10"};
    ...
    if( mxGetM(par) != 14 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f8 must be of size [14 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f8, 14);
    ...
    if( mxGetM(par) != 14 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb8 must be of size [14 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb8, 14);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 14 ) {
    mexErrMsgTxt("PARAMS.C8 must be of size [5 x 14]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C8, 70);
    ...
    if( mxGetM(par) != 14 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f9 must be of size [14 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f9, 14);
    ...
    if( mxGetM(par) != 14 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb9 must be of size [14 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb9, 14);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 14 ) {
    mexErrMsgTxt("PARAMS.C9 must be of size [5 x 14]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C9, 70);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb10 must be of size [5 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb10, 5);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub10 must be of size [5 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub10, 5);

	/* call solver */
	exitflag = acrobot_QP_solver_solve(&params, &output, &info);
	...
	copyCArrayToM( output.z10, mxGetPr(outvar), 5);
