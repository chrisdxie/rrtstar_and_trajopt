...
#include "mex.h"
#include "../include/rally_car_QP_solver.h"

/* copy functions */
void copyCArrayToM(rally_car_QP_solver_FLOAT *src, double *dest, int dim) {
    while (dim--) {
        *dest++ = (double)*src++;
    }
}
void copyMArrayToC(double *src, rally_car_QP_solver_FLOAT *dest, int dim) {
    while (dim--) {
        *dest++ = (rally_car_QP_solver_FLOAT)*src++;
    }
}
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )  
{
	...
	const char *infofields[15] = { "it",
							   ...
							   "step_cc",
							   "solvetime"};
	rally_car_QP_solver_params params;
	rally_car_QP_solver_output output;
	rally_car_QP_solver_info info;
	
	/* Check for proper number of arguments */
    if (nrhs != 1) {
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help rally_car_QP_solver_mex' for details.");
    }    
	if (nlhs > 3) {
    ...
    mexErrMsgTxt("PARAMS.f1 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f1, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb1 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb1, 28);
    ...
    mexErrMsgTxt("PARAMS.ub1 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub1, 12);
    ...
    if( mxGetM(par) != 17 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C1 must be of size [17 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C1, 476);
    ...
    mexErrMsgTxt("PARAMS.e1 must be of size [17 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e1, 17);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f2 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f2, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb2 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb2, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub2 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub2, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C2 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C2, 252);
    ...
    mexErrMsgTxt("PARAMS.e2 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e2, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f3 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f3, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb3 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb3, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub3 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub3, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C3 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C3, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e3 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e3, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f4 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f4, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb4 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb4, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub4 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub4, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C4 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C4, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e4 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e4, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f5 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f5, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb5 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb5, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub5 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub5, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C5 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C5, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e5 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e5, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f6 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f6, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb6 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb6, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub6 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub6, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C6 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C6, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e6 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e6, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f7 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f7, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb7 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb7, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub7 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub7, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C7 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C7, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e7 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e7, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f8 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f8, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb8 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb8, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub8 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub8, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C8 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C8, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e8 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e8, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f9 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f9, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb9 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb9, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub9 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub9, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C9 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C9, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e9 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e9, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f10 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f10, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb10 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb10, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub10 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub10, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C10 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C10, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e10 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e10, 9);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f11 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f11, 28);
    ...
    if( mxGetM(par) != 28 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb11 must be of size [28 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb11, 28);
    ...
    if( mxGetM(par) != 12 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub11 must be of size [12 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub11, 12);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 28 ) {
    mexErrMsgTxt("PARAMS.C11 must be of size [9 x 28]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C11, 252);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e11 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e11, 9);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb12 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb12, 9);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub12 must be of size [9 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub12, 9);

	/* call solver */
	exitflag = rally_car_QP_solver_solve(&params, &output, &info);
	
	/* copy output to matlab arrays */
	plhs[0] = mxCreateStructMatrix(1, 1, 12, outputnames);
	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z1, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z1", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z2, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z2", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z3, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z3", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z4, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z4", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z5, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z5", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z6, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z6", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z7, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z7", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z8, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z8", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z9, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z9", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z10, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z10", outvar);

	outvar = mxCreateDoubleMatrix(12, 1, mxREAL);
	copyCArrayToM( output.z11, mxGetPr(outvar), 12);
	mxSetField(plhs[0], 0, "z11", outvar);

	outvar = mxCreateDoubleMatrix(9, 1, mxREAL);
	copyCArrayToM( output.z12, mxGetPr(outvar), 9);
