 ...
 */
void cartpole_QP_solver_LA_INITIALIZEVECTOR_271(cartpole_QP_solver_FLOAT* vec, cartpole_QP_solver_FLOAT value)
{
	int i;
	for( i=0; i<271; i++ )
	{
...
/*
 * Initializes a vector of length 99 with a value.
 */
void cartpole_QP_solver_LA_INITIALIZEVECTOR_99(cartpole_QP_solver_FLOAT* vec, cartpole_QP_solver_FLOAT value)
{
	int i;
	for( i=0; i<99; i++ )
	{
 ...
 */
void cartpole_QP_solver_LA_INITIALIZEVECTOR_390(cartpole_QP_solver_FLOAT* vec, cartpole_QP_solver_FLOAT value)
{
	int i;
	for( i=0; i<390; i++ )
	{
 ...
 */
void cartpole_QP_solver_LA_DOTACC_390(cartpole_QP_solver_FLOAT *x, cartpole_QP_solver_FLOAT *y, cartpole_QP_solver_FLOAT *z)
{
	int i;
	for( i=0; i<390; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 271.
 */
void cartpole_QP_solver_LA_VVADD3_271(cartpole_QP_solver_FLOAT *u, cartpole_QP_solver_FLOAT *v, cartpole_QP_solver_FLOAT *w, cartpole_QP_solver_FLOAT *z)
{
	int i;
	for( i=0; i<271; i++ ){
		z[i] = u[i] + v[i] + w[i];
 ...
 */
void cartpole_QP_solver_LA_VSUB2_271(cartpole_QP_solver_FLOAT *x, cartpole_QP_solver_FLOAT *y, cartpole_QP_solver_FLOAT *z)
{
	int i;
	for( i=0; i<271; i++){
		z[i] = -x[i] - y[i];
...
int cartpole_QP_solver_LINESEARCH_BACKTRACKING_AFFINE(cartpole_QP_solver_FLOAT *l, cartpole_QP_solver_FLOAT *s, cartpole_QP_solver_FLOAT *dl, cartpole_QP_solver_FLOAT *ds, cartpole_QP_solver_FLOAT *a, cartpole_QP_solver_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (cartpole_QP_solver_FLOAT)390;
    return lsIt;
}
 ...
 */
void cartpole_QP_solver_LA_VSUB5_390(cartpole_QP_solver_FLOAT *u, cartpole_QP_solver_FLOAT *v, cartpole_QP_solver_FLOAT mu,  cartpole_QP_solver_FLOAT sigma, cartpole_QP_solver_FLOAT *x)
{
	int i;
	for( i=0; i<390; i++){
		x[i] = u[i]*v[i] - mu;
 ...
 * Vector subtraction z = x - y for vectors of length 271.
 */
void cartpole_QP_solver_LA_VSUB_271(cartpole_QP_solver_FLOAT *x, cartpole_QP_solver_FLOAT *y, cartpole_QP_solver_FLOAT *z)
{
	int i;
	for( i=0; i<271; i++){
		z[i] = x[i] - y[i];
 ...
 */
void cartpole_QP_solver_LA_VSUB7_390(cartpole_QP_solver_FLOAT *l, cartpole_QP_solver_FLOAT *r, cartpole_QP_solver_FLOAT *s, cartpole_QP_solver_FLOAT *dl, cartpole_QP_solver_FLOAT *ds)
{
	int i;
	for( i=0; i<390; i++){
 ...
 */
void cartpole_QP_solver_LA_VADD_271(cartpole_QP_solver_FLOAT *x, cartpole_QP_solver_FLOAT *y)
{
	int i;
	for( i=0; i<271; i++){
		x[i] += y[i];
...
/*
 * Vector addition x = x + y for vectors of length 99.
 */
void cartpole_QP_solver_LA_VADD_99(cartpole_QP_solver_FLOAT *x, cartpole_QP_solver_FLOAT *y)
{
	int i;
	for( i=0; i<99; i++){
		x[i] += y[i];
 ...
 */
void cartpole_QP_solver_LA_VADD_390(cartpole_QP_solver_FLOAT *x, cartpole_QP_solver_FLOAT *y)
{
	int i;
	for( i=0; i<390; i++){
		x[i] += y[i];
...
int cartpole_QP_solver_LINESEARCH_BACKTRACKING_COMBINED(cartpole_QP_solver_FLOAT *z, cartpole_QP_solver_FLOAT *v, cartpole_QP_solver_FLOAT *l, cartpole_QP_solver_FLOAT *s, cartpole_QP_solver_FLOAT *dz, cartpole_QP_solver_FLOAT *dv, cartpole_QP_solver_FLOAT *dl, cartpole_QP_solver_FLOAT *ds, cartpole_QP_solver_FLOAT *a, cartpole_QP_solver_FLOAT *mu)
{
    ...
    *a = a_gamma;
    *mu /= (cartpole_QP_solver_FLOAT)390;
    return lsIt;
}
...
cartpole_QP_solver_FLOAT cartpole_QP_solver_z[271];
cartpole_QP_solver_FLOAT cartpole_QP_solver_v[99];
cartpole_QP_solver_FLOAT cartpole_QP_solver_dz_aff[271];
cartpole_QP_solver_FLOAT cartpole_QP_solver_dv_aff[99];
cartpole_QP_solver_FLOAT cartpole_QP_solver_grad_cost[271];
cartpole_QP_solver_FLOAT cartpole_QP_solver_grad_eq[271];
cartpole_QP_solver_FLOAT cartpole_QP_solver_rd[271];
cartpole_QP_solver_FLOAT cartpole_QP_solver_l[390];
cartpole_QP_solver_FLOAT cartpole_QP_solver_s[390];
cartpole_QP_solver_FLOAT cartpole_QP_solver_lbys[390];
cartpole_QP_solver_FLOAT cartpole_QP_solver_dl_aff[390];
cartpole_QP_solver_FLOAT cartpole_QP_solver_ds_aff[390];
cartpole_QP_solver_FLOAT cartpole_QP_solver_dz_cc[271];
cartpole_QP_solver_FLOAT cartpole_QP_solver_dv_cc[99];
cartpole_QP_solver_FLOAT cartpole_QP_solver_dl_cc[390];
cartpole_QP_solver_FLOAT cartpole_QP_solver_ds_cc[390];
cartpole_QP_solver_FLOAT cartpole_QP_solver_ccrhs[390];
cartpole_QP_solver_FLOAT cartpole_QP_solver_grad_ineq[271];
...
cartpole_QP_solver_FLOAT cartpole_QP_solver_H19[5] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
cartpole_QP_solver_FLOAT cartpole_QP_solver_f19[5] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
...
cartpole_QP_solver_FLOAT cartpole_QP_solver_Lbyrd19[5];
...
cartpole_QP_solver_FLOAT cartpole_QP_solver_ctv19[5];
int cartpole_QP_solver_lbIdx19[5] = {0, 1, 2, 3, 4};
...
cartpole_QP_solver_FLOAT cartpole_QP_solver_rilb19[5];
...
int cartpole_QP_solver_ubIdx19[5] = {0, 1, 2, 3, 4};
cartpole_QP_solver_FLOAT* cartpole_QP_solver_lub19 = cartpole_QP_solver_l + 385;
cartpole_QP_solver_FLOAT* cartpole_QP_solver_sub19 = cartpole_QP_solver_s + 385;
cartpole_QP_solver_FLOAT* cartpole_QP_solver_lubbysub19 = cartpole_QP_solver_lbys + 385;
cartpole_QP_solver_FLOAT cartpole_QP_solver_riub19[5];
cartpole_QP_solver_FLOAT* cartpole_QP_solver_dlubaff19 = cartpole_QP_solver_dl_aff + 385;
cartpole_QP_solver_FLOAT* cartpole_QP_solver_dsubaff19 = cartpole_QP_solver_ds_aff + 385;
cartpole_QP_solver_FLOAT* cartpole_QP_solver_dlubcc19 = cartpole_QP_solver_dl_cc + 385;
cartpole_QP_solver_FLOAT* cartpole_QP_solver_dsubcc19 = cartpole_QP_solver_ds_cc + 385;
cartpole_QP_solver_FLOAT* cartpole_QP_solver_ccrhsub19 = cartpole_QP_solver_ccrhs + 385;
cartpole_QP_solver_FLOAT cartpole_QP_solver_Phi19[5];
cartpole_QP_solver_FLOAT cartpole_QP_solver_D19[5] = {-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000};
cartpole_QP_solver_FLOAT cartpole_QP_solver_W19[5];
...
info->it = 0;
cartpole_QP_solver_LA_INITIALIZEVECTOR_271(cartpole_QP_solver_z, 0);
cartpole_QP_solver_LA_INITIALIZEVECTOR_99(cartpole_QP_solver_v, 1);
cartpole_QP_solver_LA_INITIALIZEVECTOR_390(cartpole_QP_solver_l, 10);
cartpole_QP_solver_LA_INITIALIZEVECTOR_390(cartpole_QP_solver_s, 10);
info->mu = 0;
cartpole_QP_solver_LA_DOTACC_390(cartpole_QP_solver_l, cartpole_QP_solver_s, &info->mu);
info->mu /= 390;
while( 1 ){
info->pobj = 0;
...
cartpole_QP_solver_LA_DIAG_QUADFCN_5(cartpole_QP_solver_H19, cartpole_QP_solver_f19, cartpole_QP_solver_z19, cartpole_QP_solver_grad_cost19, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
cartpole_QP_solver_LA_DENSE_DIAGZERO_MVMSUB3_5_14_5(params->C19, cartpole_QP_solver_z18, cartpole_QP_solver_D19, cartpole_QP_solver_z19, params->e19, cartpole_QP_solver_v18, cartpole_QP_solver_re18, &info->dgap, &info->res_eq);
...
cartpole_QP_solver_LA_DIAGZERO_MTVM_5_5(cartpole_QP_solver_D19, cartpole_QP_solver_v18, cartpole_QP_solver_grad_eq19);
info->res_ineq = 0;
...
cartpole_QP_solver_LA_VSUBADD3_5(params->lb20, cartpole_QP_solver_z19, cartpole_QP_solver_lbIdx19, cartpole_QP_solver_llb19, cartpole_QP_solver_slb19, cartpole_QP_solver_rilb19, &info->dgap, &info->res_ineq);
cartpole_QP_solver_LA_VSUBADD2_5(cartpole_QP_solver_z19, cartpole_QP_solver_ubIdx19, params->ub20, cartpole_QP_solver_lub19, cartpole_QP_solver_sub19, cartpole_QP_solver_riub19, &info->dgap, &info->res_ineq);
...
cartpole_QP_solver_LA_VVADD3_271(cartpole_QP_solver_grad_cost, cartpole_QP_solver_grad_eq, cartpole_QP_solver_grad_ineq, cartpole_QP_solver_rd);
...
cartpole_QP_solver_LA_DIAG_CHOL_ONELOOP_LBUB_5_5_5(cartpole_QP_solver_H19, cartpole_QP_solver_llbbyslb19, cartpole_QP_solver_lbIdx19, cartpole_QP_solver_lubbysub19, cartpole_QP_solver_ubIdx19, cartpole_QP_solver_Phi19);
cartpole_QP_solver_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_5(cartpole_QP_solver_Phi19, cartpole_QP_solver_D19, cartpole_QP_solver_W19);
cartpole_QP_solver_LA_DIAG_FORWARDSUB_5(cartpole_QP_solver_Phi19, cartpole_QP_solver_rd19, cartpole_QP_solver_Lbyrd19);
...
cartpole_QP_solver_LA_DENSE_DIAGZERO_MMT2_5_14_5(cartpole_QP_solver_V18, cartpole_QP_solver_W19, cartpole_QP_solver_Yd18);
cartpole_QP_solver_LA_DENSE_DIAGZERO_2MVMSUB2_5_14_5(cartpole_QP_solver_V18, cartpole_QP_solver_Lbyrd18, cartpole_QP_solver_W19, cartpole_QP_solver_Lbyrd19, cartpole_QP_solver_re18, cartpole_QP_solver_beta18);
...
cartpole_QP_solver_LA_DENSE_BACKWARDSUB_5(cartpole_QP_solver_Ld18, cartpole_QP_solver_yy18, cartpole_QP_solver_dvaff18);
...
cartpole_QP_solver_LA_DIAGZERO_MTVM_5_5(cartpole_QP_solver_D19, cartpole_QP_solver_dvaff18, cartpole_QP_solver_grad_eq19);
cartpole_QP_solver_LA_VSUB2_271(cartpole_QP_solver_rd, cartpole_QP_solver_grad_eq, cartpole_QP_solver_rd);
...
cartpole_QP_solver_LA_DIAG_FORWARDBACKWARDSUB_5(cartpole_QP_solver_Phi19, cartpole_QP_solver_rd19, cartpole_QP_solver_dzaff19);
...
cartpole_QP_solver_LA_VSUB_INDEXED_5(cartpole_QP_solver_dzaff19, cartpole_QP_solver_lbIdx19, cartpole_QP_solver_rilb19, cartpole_QP_solver_dslbaff19);
cartpole_QP_solver_LA_VSUB3_5(cartpole_QP_solver_llbbyslb19, cartpole_QP_solver_dslbaff19, cartpole_QP_solver_llb19, cartpole_QP_solver_dllbaff19);
cartpole_QP_solver_LA_VSUB2_INDEXED_5(cartpole_QP_solver_riub19, cartpole_QP_solver_dzaff19, cartpole_QP_solver_ubIdx19, cartpole_QP_solver_dsubaff19);
cartpole_QP_solver_LA_VSUB3_5(cartpole_QP_solver_lubbysub19, cartpole_QP_solver_dsubaff19, cartpole_QP_solver_lub19, cartpole_QP_solver_dlubaff19);
...
cartpole_QP_solver_LA_VSUB5_390(cartpole_QP_solver_ds_aff, cartpole_QP_solver_dl_aff, info->mu, info->sigma, cartpole_QP_solver_ccrhs);
...
cartpole_QP_solver_LA_DENSE_MVMSUB1_5_5(cartpole_QP_solver_Lsd17, cartpole_QP_solver_yy16, cartpole_QP_solver_beta17, cartpole_QP_solver_bmy17);
cartpole_QP_solver_LA_DENSE_FORWARDSUB_5(cartpole_QP_solver_Ld17, cartpole_QP_solver_bmy17, cartpole_QP_solver_yy17);
cartpole_QP_solver_LA_VSUB6_INDEXED_5_5_5(cartpole_QP_solver_ccrhsub19, cartpole_QP_solver_sub19, cartpole_QP_solver_ubIdx19, cartpole_QP_solver_ccrhsl19, cartpole_QP_solver_slb19, cartpole_QP_solver_lbIdx19, cartpole_QP_solver_rd19);
cartpole_QP_solver_LA_DIAG_FORWARDSUB_5(cartpole_QP_solver_Phi19, cartpole_QP_solver_rd19, cartpole_QP_solver_Lbyrd19);
cartpole_QP_solver_LA_DENSE_DIAGZERO_2MVMADD_5_14_5(cartpole_QP_solver_V18, cartpole_QP_solver_Lbyrd18, cartpole_QP_solver_W19, cartpole_QP_solver_Lbyrd19, cartpole_QP_solver_beta18);
cartpole_QP_solver_LA_DENSE_MVMSUB1_5_5(cartpole_QP_solver_Lsd18, cartpole_QP_solver_yy17, cartpole_QP_solver_beta18, cartpole_QP_solver_bmy18);
cartpole_QP_solver_LA_DENSE_FORWARDSUB_5(cartpole_QP_solver_Ld18, cartpole_QP_solver_bmy18, cartpole_QP_solver_yy18);
cartpole_QP_solver_LA_DENSE_BACKWARDSUB_5(cartpole_QP_solver_Ld18, cartpole_QP_solver_yy18, cartpole_QP_solver_dvcc18);
...
cartpole_QP_solver_LA_DIAGZERO_MTVM_5_5(cartpole_QP_solver_D19, cartpole_QP_solver_dvcc18, cartpole_QP_solver_grad_eq19);
cartpole_QP_solver_LA_VSUB_271(cartpole_QP_solver_rd, cartpole_QP_solver_grad_eq, cartpole_QP_solver_rd);
...
cartpole_QP_solver_LA_DIAG_FORWARDBACKWARDSUB_5(cartpole_QP_solver_Phi19, cartpole_QP_solver_rd19, cartpole_QP_solver_dzcc19);
...
cartpole_QP_solver_LA_VEC_DIVSUB_MULTSUB_INDEXED_5(cartpole_QP_solver_ccrhsl19, cartpole_QP_solver_slb19, cartpole_QP_solver_llbbyslb19, cartpole_QP_solver_dzcc19, cartpole_QP_solver_lbIdx19, cartpole_QP_solver_dllbcc19);
cartpole_QP_solver_LA_VEC_DIVSUB_MULTADD_INDEXED_5(cartpole_QP_solver_ccrhsub19, cartpole_QP_solver_sub19, cartpole_QP_solver_lubbysub19, cartpole_QP_solver_dzcc19, cartpole_QP_solver_ubIdx19, cartpole_QP_solver_dlubcc19);
cartpole_QP_solver_LA_VSUB7_390(cartpole_QP_solver_l, cartpole_QP_solver_ccrhs, cartpole_QP_solver_s, cartpole_QP_solver_dl_cc, cartpole_QP_solver_ds_cc);
cartpole_QP_solver_LA_VADD_271(cartpole_QP_solver_dz_cc, cartpole_QP_solver_dz_aff);
cartpole_QP_solver_LA_VADD_99(cartpole_QP_solver_dv_cc, cartpole_QP_solver_dv_aff);
cartpole_QP_solver_LA_VADD_390(cartpole_QP_solver_dl_cc, cartpole_QP_solver_dl_aff);
cartpole_QP_solver_LA_VADD_390(cartpole_QP_solver_ds_cc, cartpole_QP_solver_ds_aff);
