...
typedef struct cartpole_QP_solver_params
{
    ...
    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f15[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb15[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub15[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C15[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e15[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f16[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb16[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub16[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C16[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e16[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f17[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb17[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub17[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C17[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e17[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f18[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb18[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub18[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C18[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e18[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f19[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb19[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub19[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C19[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e19[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f20[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb20[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub20[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C20[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e20[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f21[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb21[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub21[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C21[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e21[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f22[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb22[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub22[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C22[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e22[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f23[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb23[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub23[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C23[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e23[5];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT f24[14];

    /* vector of size 14 */
    cartpole_QP_solver_FLOAT lb24[14];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT ub24[6];

    /* matrix of size [5 x 14] (column major format) */
    cartpole_QP_solver_FLOAT C24[70];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT e24[5];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT lb25[5];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT ub25[5];
...
typedef struct cartpole_QP_solver_output
{
    ...
    /* vector of size 6 */
    cartpole_QP_solver_FLOAT z20[6];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT z21[6];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT z22[6];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT z23[6];

    /* vector of size 6 */
    cartpole_QP_solver_FLOAT z24[6];

    /* vector of size 5 */
    cartpole_QP_solver_FLOAT z25[5];
