...
namespace cfg {
const double improve_ratio_threshold = .2; // .25
...
int main(int argc, char* argv[]) {
	...
	bounds.u_min << -10;
	bounds.u_max << 10;
	bounds.x_min << -10, -10, -2*M_PI, -10;
	bounds.x_max << 10, 10, 2*M_PI, 10;
	//bounds.x_min << -50, -50, -8*M_PI, -50;
	//bounds.x_max << 50, 50, 8*M_PI, 50;
	bounds.delta_min = 0;
	bounds.delta_max = 1;
