#ifndef ACROBOT_PLOT_BITSTAR_H_
#define ACROBOT_PLOT_BITSTAR_H_
...
np::ndarray ac_eigen_to_ndarray(const MatrixXd& m) {
	if (m.cols() == 1) {
...
py::object ac_init_display() {
	...
	std::string working_dir = "/home/chris/rrtstar_and_trajopt/other_things/My_BITStar_Impl/acrobot";
