...
py::object init_display() {
	...
	std::string working_dir = "/Users/ChrisXie/school/research/RRTSTAR_TrajOpt_Project/RRTSTAR_and_TrajOpt/other_things/My_BITStar_Impl/cartpole";
...
void plot(py::object& plotter, np::ndarray& goal_path, np::ndarray& obstacles, int iters, double cost,
