/*! \file components/samplers/boost_random_uniform.h
...
#ifndef _SMP_SAMPLER_BOOST_RANDOM_UNIFORM_H_
#define _SMP_SAMPLER_BOOST_RANDOM_UNIFORM_H_
...
namespace smp {
    ...
    */
    ...
    class sampler_uniform : public sampler_base< typeparams > {
        ...
        typedef boost::variate_generator<RANDOM_ENGINE, DIST> GENERATOR;
