/*! \file planners/informedrrtstar.h
...
#ifndef _SMP_PLANNER_INFORMEDRRTSTAR_H_
#define _SMP_PLANNER_INFORMEDRRTSTAR_H_
...
namespace smp {
    ...
    */
    class informedrrtstar_vertex_data {
  ...
  another edge data class that includes the edge_cost variable.
    */
    class informedrrtstar_edge_data {
    ...
    */
    ...
    class informedrrtstar : public planner_incremental<typeparams> {
    ...
    private:
        ...
        // Best goal state and cost for Informed RRT* sampling
        state_t* best_goal;
        double best_cost;

        // Keep track of matrices L and C as well.
        MatrixXd L;
        MatrixXd C;
        ...
        VectorXd sample_from_unit_ball() {
            ...
            // Sample length
            double length = R * std::pow((*u_sampler)(), 1.0/parameters.get_dimension());

            // Sample direction
            VectorXd dir(parameters.get_dimension());
    ...
    public:
        ...
        */
         ...
         */
        informedrrtstar (sampler_t &sampler_in, distance_evaluator_t &distance_evaluator_in, 
