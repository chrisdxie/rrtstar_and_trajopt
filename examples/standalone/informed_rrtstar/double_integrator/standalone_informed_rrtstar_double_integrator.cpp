...
#include <smp/planners/informedrrtstar.hpp>
...
typedef informedrrtstar<typeparams>  informedrrtstar_t;
...
main (int argc, char* argv[]) {
  ...
  informedrrtstar_t planner (sampler, distance_evaluator, extender, collision_checker, 
  ...
  planner.parameters.set_max_radius (7.0);   // This parameter should be set to a high enough value. In practice,
  ...
  MatrixXd obstacles(4, 3); obstacles.setZero();
